...
### M4. Зафиксировать границы `v1` и контракт следующего этапа
...
### M5. Обязательная проверка результата месяца
...
**Checkpoint:** версия `v1` считается закрытой и пригодной для внутренней эксплуатации.
...
Работа месяца прекращается после выполнения M1-M5. Дополнительные задачи не добавляются для искусственного заполнения оставшегося времени.
