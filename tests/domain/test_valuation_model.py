...
def test_create_valuation_uses_points_value_object_and_trims_reason() -> None:
    ...
    points = Points(value=25, point_type=LevelTypeEnum.ACADEMIC)
    ...
    assert valuation.points_type is LevelTypeEnum.ACADEMIC
...
def test_create_valuation_rejects_zero_points_value_object() -> None:
    ...
    points = Points(value=0, point_type=LevelTypeEnum.REPUTATION)
